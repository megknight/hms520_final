...
## TODO: @Ian -- GOT ERRORS TRYING TO IMPLEMENT YOUR APPROACH -- CHECK IT OUT
## create separate column for each recipient (some grants have up to 25 recipients listed)
...
######################################################################################
## TODO: @Ian -- INTEGRATE FGH KEYWORD SEARCH FUNCTION (lines 296+)